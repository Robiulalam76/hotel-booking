...
const Profile = () => {
    ...
    return (
        <div>
            ...
            <div class=" bg-gray-20 flex flex-wrap items-center justify-center">
                <div class="container md:w-[500px] bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out m-12">
                    <div class="h-2/4 sm:h-64 overflow-hidden">
                        <img class="w-full h-[250px] rounded-t"
                    ...
                    <div class="relative">
                        ...
                        <div class="px-7 mb-8">
                            {
                                user?.displayName ? <h2 class="text-3xl font-bold text-green-800 dark:text-gray-300">{user?.displayName}</h2> : <h2 class="text-3xl font-bold text-green-800 dark:text-gray-300">Md. Robiul Alam</h2>
                            }
                            <p class="text-gray-400 mt-2 dark:text-gray-400">Web Developer</p>
                    ...
                    {
                        user?.uid && <button className='bg-blue-600 text-white font-bold py-2 px-3 border-0 rounded-lg mb-3' onClick={handleLogOut}>LogOUt</button>
                    }
                </div>
            </div>
        </div>
